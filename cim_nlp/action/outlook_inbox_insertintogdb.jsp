...
//        read from the outllok inbox input files and insert E&R into graph database
    CIMUtil.outlook_Inbox_ReadFiles_InsertIntoGDB(ses, ol_inbox_dir_path, shankar_name_entity_id);
