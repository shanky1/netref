...
//        read from the netref contact input files and insert E&R into graph database
    CIMUtil.netref_contacts_ReadFiles_InsertIntoGDB(ses, nr_contacts_dir_path, shankar_name_entity_id);
