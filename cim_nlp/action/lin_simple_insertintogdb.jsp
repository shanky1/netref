...
//        read from the linkedin simple parsed inbox input files and insert E&R into graph database
    CIMUtil.linSimple_ReadFiles_InsertIntoGDB(ses, lin_simple_profiles_parsed_dir, shankar_name_entity_id);
