...
<%
    ...
    String profile_facebook = request.getParameter("profile_facebook");
    ...
    String status = saveProfileDetails(from_user_id, profile_name, profile_expertise, profile_linkedin, profile_facebook, hr_consent);
