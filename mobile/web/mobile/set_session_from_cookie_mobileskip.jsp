...
<%
//    System.out.println("Request handler 'set_session_from_cookie_mobileskip' was called");

    String mobile_deviceid = request.getParameter("netref_cookie_skip_mobile_id");
