...
<%!
    ...
    static int SK_USER_ID = 612;
    static String CONTACT_IMAGE_PATH = "D:\\production\\netref\\web\\mobile\\user_contact_images";
    static String PROFILE_IMAGE_PATH = "D:\\production\\netref\\web\\mobile\\profile_images";
    static String server_type = "prod"; 
    static String test_mobile_number = "+919901424531";
    static String test_user_id = "10";
...
//        test_numbers.put("+918951092157", "Ajay");
        ...
        test_numbers.put("+919112345678", "Test3");
        test_numbers.put("+919212345678", "Test3");
...
//                System.out.println("to_userId : "+to_userId+" invitation_status : "+invitation_status);
    ...
    public String getProfessionalDetails(String professional_id) {
        String  pros_name = "";
...
//                            (pros_mobile != null && pros_mobile.trim().length() > 0 ? " Contact: "+pros_mobile +"<br>" : "") +
                            (pros_mobile != null && pros_mobile.trim().length() > 0 ? "" +
                                    "<button id='contact_professional' onclick=\"contactProfessional(event);\" type='button' class='btn btn-info btn-sm' style='display:inline;border-radius:5px; padding: .1rem .3rem; box-shadow: 0.09em 0.09em 0.09em 0.05em #888888; margin-bottom: 5px;'>Contact</button><br>" : "") +
