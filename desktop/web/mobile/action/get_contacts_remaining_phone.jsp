...
//    System.out.println(new Date()+"\t updated_flag: "+updated_flag);
    ...
    if(load_contacts_from_session) {
        ...
        System.out.println(new Date()+"\t start getRemainingContacts_FromRelationship_AL from session");
	...
	System.out.println(new Date()+"\t start getRemainingContacts_FromRelationship_AL from DB");
